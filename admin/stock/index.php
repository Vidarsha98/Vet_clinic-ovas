...
<script>
	$(document).ready(function(){
        $('#create_new').click(function(){
			uni_modal("Add New Stock","stock/manage_stock.php",'mid-large')
		})
        $('.edit_data').click(function(){
			uni_modal("Update Service Details","stock/manage_stock.php?id="+$(this).attr('data-id'),'mid-large')
		})
